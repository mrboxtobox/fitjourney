...
const EXERCISE_IMAGES: Record<string, string> = {
  ...
  'band-face-pull': '/exercises/band-face-pull.png',
  'band-pallof-press': '/exercises/band-pallof-press.png',
  'band-shoulder-dislocate': '/exercises/band-shoulder-dislocate.png',
