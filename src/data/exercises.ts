...
// Exercises with a true animated clip (/motion/<id>.mp4, generated by
// scripts/generate-motion-videos.ts from the reviewed start frame). Video wins
// over the two-frame flip; the flip remains the fallback while a clip is absent.
// Three clips failed review repeatedly and fall back to the flip until a better
